...
import { restRouter } from "../shim/rest-router.js"
import { corsAllow } from "../shim/auth.js"
...
export async function startHTTPServer(createServer: () => Server, port: number) {
  ...
  const expressServer = app.listen(port, "0.0.0.0", () => {
    ...
    console.error(`✓ Actions REST health: http://0.0.0.0:${port}/v1/health`)
  })
